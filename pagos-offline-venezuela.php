 ...
 * GitHub Plugin URI: https://github.com/guillermoscript/pagos-offline-venezuela.git
 * License:           GPL-2.0+
...
use base\includes\Pagos_Offline_Venezuela;
/**
...
function activate_pagos_offline_venezuela() {
	...
	Pagos_Offline_Venezuela_Activator::activate();
}
...
function deactivate_pagos_offline_venezuela() {
	...
	Pagos_Offline_Venezuela_Deactivator::deactivate();
}
...
function run_pagos_offline_venezuela() {
	...
	$plugin = new Pagos_Offline_Venezuela();
	$plugin->run();
